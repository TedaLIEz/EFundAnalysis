...
def mock_fund_data():
    ...
    return pd.DataFrame({
        'item': [
            '基金代码', '基金名称', '基金全称', '成立时间', '最新规模',
            '基金公司', '基金经理', '托管银行', '基金类型', '评级机构',
            '基金评级', '投资策略', '投资目标', '业绩比较基准'
        ],
        'value': [
            '000001', '华夏成长混合', '华夏成长前收费', '2001-12-18', '27.30亿',
            '华夏基金管理有限公司', '王泽实 万方方', '中国建设银行股份有限公司', '混合型-偏股', '晨星评级',
            '一星基金', '在股票投资方面，本基金重点投资于预期利润或收入具有良好增长潜力的成长型上市公司发行的股票，从...',
