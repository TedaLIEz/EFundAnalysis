...
class KYCWorkflow(Workflow):
    ...
    @step
    async def collect_basic_info(self, ev: StartEvent) -> BasicInfoEvent:
    ...
    @step
    async def collect_investment_preferences(self, ev: BasicInfoEvent) -> InvestmentPreferenceEvent:
    ...
    @step
    async def assess_risk_profile(self, ev: InvestmentPreferenceEvent) -> RiskAssessmentEvent:
    ...
    @step
    async def generate_customer_profile(self, ev: RiskAssessmentEvent) -> StopEvent:
        ...
        try:
            ...
            recommendation = await self.llm.acomplete(summary_prompt)
